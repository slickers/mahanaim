...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Database Pendeta</h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
                    ...
                    <td>
                      <div class="btn-group" role="group">
                        ...
                        <?php if ($_SESSION['level'] == 'admin') {
                          include('menu/admin_pbtn.php');
                        } else {
                          include('menu/operator_pbtn.php');
                        }
                        ?>
                      </div>
                    </td>
        ...
        <div class="modal-body">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select class="custom-select" name="status_pdt">
                <option selected="Aktif">Aktif</option>
